...
public class ViewTermController implements Initializable {

    @FXML
    private TextArea ViewTermField;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (Term t : User.termsList) {
            stringBuilder.append(i + ". " + t.termTitle + "\t\t" + t.termBeginning.printDate() + "\t\t" +
                    t.gradeRegistration.printDate() + "\t\t" + t.termEnding.printDate() + "\t\t" + t.getSubjects() + "\n");
            i++;
        }
        ViewTermField.setText(String.valueOf(stringBuilder));
    }
}
